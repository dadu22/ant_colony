...
while True:
    ...
    if Sim_active:
        ...
        seed_display = seed_font.render(f"seed: {seed_text}", True, (255, 255, 255))  # White text
        seed_rect = seed_display.get_rect(topleft=(10, 10))  # Position at (10, 10)
        ...
        generate_button_y_original = generate_button.y
        generate_button.y = generate_button_y_original - 10
        pygame.draw.rect(screen, (colors['rock']), generate_button, border_radius=15)
        ...
        generate_button.y = generate_button_y_original
        ...
        if start_simulation and not map_generating:
            pygame.draw.rect(screen, (colors['rock']), button_rect, border_radius=15)
